...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义----------------
#define    LCD_RESET                PCout(7)   //LCD复位
#define    LCD_BL                   PDout(4)   //LCD背光

#define    LCD_CS                   PBout(11)  //片选端口
#define    LCD_RS                   PBout(15)  //数据/命令
//#define    LCD_SCL                  PBout(13)  //写数据
//#define    LCD_SDA                  PGout(7)   //读数据
#define    LCD_SCL                  PFout(7)  //写数据
#define    LCD_SDA                  PFout(9)   //读数据
#define    LCD_SDO                  PDout(0)   //SDO
